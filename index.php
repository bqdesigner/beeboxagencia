...
<body>
    ...
    <header>
        <div class="container">
            ...
            <a href="javascript:;" class="cta"> Faça parte da transformação </a>
        </div>
    </header> 
    <main>
        <div class="container">
           <div class="row">
               <div class="col-12 col-md-6">
                    ...
                    <a href="javascript:;" class="link-scroll animate-flicker"> Role para baixo </a>
               </div>
               <div class="col-12 col-md-6">
    ...
    <section class="content-4 container">
